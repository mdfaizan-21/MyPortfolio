      ...
      children: [
        {
          ...
          description: [
           "A streamlined Inventory Management System built during my internship to help small businesses efficiently track stock levels, prevent overstocking, and avoid stockouts. It includes product management, supplier tracking, purchase/sales updates, low-stock alerts, and real-time inventory visibility. Initially console-based and later upgraded to a clean JavaFX UI, the system was developed using Java and JDBC with a modular, scalable architecture—demonstrating strong problem-solving, database design, and end-to-end development skills."
          ],
        },
        {
          id: 2,
